...
@observer
export default class Follow extends React.Component<IProps, {}> {
  ...
  public render() {
    return (
      <div className='navbar-fixed page' data-name='follow'>
        <Header
          back={true}
          center='我的关注'
          right={
            <a href='/message/school-search' title=''>同校搜索</a>
          } />
        <StyeldDiv className='page-search border1px'>
          <InputSearch placeholder='部门/姓名' onChange={this.onChange} />
        </StyeldDiv>
        <div className='page-content'>
          <StyledText>全部关注</StyledText>
