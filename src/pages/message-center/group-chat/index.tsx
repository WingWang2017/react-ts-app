...
import { yuyinIcon, groupchat } from 'src/images';

const width = { width: '.44rem' };
@observer
export default class GroupChat extends React.Component<IProps, {}> {
  ...
  public render() {
    return (
      <div className='navbar-fixed toolbar-fixed page chatPage' data-name='group-chat'>
        <Header
          back={true}
          center='群聊(2)'
          right={
